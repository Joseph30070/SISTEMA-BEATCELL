...
// 🔥 MAPEAR ROLES A LOS DEL SISTEMA
$ROLE_MAP = [
  'ADMIN' => 'ADMINISTRADOR',
  'ADMISION' => 'ADMISION',
  'ASESOR' => 'ASESOR'
...
// Si existe en el mapa, reemplazar
if (isset($ROLE_MAP[$ROLE])) {
  $ROLE = $ROLE_MAP[$ROLE];
}

// EJECUTAR LIMPIEZA AUTOMÁTICA (FAKE CRON)
//require_once __DIR__ . '/../cron_fake.php';   // ← por ahora como comentario para despues fusionarlo con home.php
...
<body class="bg-gray-50">
  ...
  <!-- Logo -->
<img src="../img/logo-beatcell.png" class="w-8 h-8 object-contain" alt="Logo">

  <!-- Texto -->
  <div>
    <h1 class="text-xl font-bold tracking-wide">
      <span class="text-gray-800">SISTEMA</span>
      ...
      <nav class="p-3 space-y-1 flex-1 overflow-y-auto">
        ...
        <?php if (in_array($ROLE, ['ASESOR','ADMINISTRADOR'], true)): ?>
          <a href="<?= $base ?>/registro_alumnos.php"
            ...
            <i class="fas fa-user-plus"></i> <span>Registro Alumnos</span>
          </a>
        <?php endif; ?>
        ...
        <?php if ($ROLE === 'ADMINISTRADOR'): ?>
          <a href="<?= $base ?>/registrar_usuario.php"
            ...
            <i class="fas fa-user-cog"></i><span>Agregar nuevo Practicante</span>
          </a>
        <?php endif; ?>
